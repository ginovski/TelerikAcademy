namespace ConsoleWebServer.Framework
{
    ...
    {
        private const string InvalidMethodMessage = "Expected method with signature IActionResult {0}(string) in class {1}Controller";
        ...
        public IActionResult InvokeAction(Controller controller, ActionDescriptor actionDescriptor)
        {
            ...
            {
                throw new HttpNotFound(string.Format(InvalidMethodMessage, actionDescriptor.ActionName, actionDescriptor.ControllerName));
            }
