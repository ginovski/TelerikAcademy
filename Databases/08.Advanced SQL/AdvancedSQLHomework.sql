...
INSERT INTO Users ([UserName], [PassWord], [Last Login], [GroupID]) VALUES
	('Pesho Peshev', 'pe6kata', GETDATE(), 1),
	('Mitaka', 'mitko123', GETDATE(), 1),
	('Georgi Petrov', 'go6ouuu', GETDATE(), 2),
GO

/* Task 20 Write SQL statements to update some of the records in the Users and Groups tables.*/
UPDATE Groups
	SET [Name] = 'Mitkovci'
	WHERE [Name] LIKE 'Peshovci%'

UPDATE Users
	SET [UserName] = 'Spas'
	WHERE [UserName] = 'Mitaka'
