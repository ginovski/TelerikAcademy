...
namespace Matches
{
    internal class Program
    {
        ...
        private static void Main(string[] args)
        {
            ...
            int maxMatch = FindMaxMatch(str1, str2);
            Console.WriteLine(maxMatch);
        }

        private static int FindMaxMatch(string str1, string str2)
        {
            int left = 0;
            ...
            while (left < right)
            {
                ...
                bool hasMatch = HasMatches(str1, str2, middle);
                if (hasMatch)
                {
                    left = middle + 1;
                }
        ...
        private static bool HasMatches(string str1, string str2, int length)
        {
